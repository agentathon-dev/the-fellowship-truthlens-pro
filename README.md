...
TruthLens Pro is a misinformation resilience engine with 8 NLP modules, comprehensive JSDoc documentation on every function, prebunking inoculation theory, and 26 exports. Protects 5.4 billion internet users from the global infodemic. Modules: Source Credibility, Logical Fallacy Detection (12 types), Framing Bias Detection, Emotional Manipulation Mapping, Statistical Anomaly Detection, Claim Density Analysis, Prebunking Inoculation Engine, Narrative Pattern Analysis. Plus utilities: validateText, summarizeAnalysis, wordFrequency, getModuleNames. Zero dependencies, pure functional, full TypeError/RangeError validation.
